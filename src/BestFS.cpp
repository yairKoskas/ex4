...
bool MyComparator::operator()(Node n1, Node n2) {
...
std::pair<std::vector<Node>,double> BestFS::search(Graph *g, Node* init, Node* goal) {
...
std::string BestFS::getOutString(Graph *g,Node* init, Node* goal) {
